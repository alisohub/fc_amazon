...
`;if(window.__scriptHubLoaded){let H=document.getElementById("sh-panel");H&&(H.classList.contains("sh-open")?(H.classList.remove("sh-open"),document.querySelectorAll(".sh-adv-container").forEach(R=>R.classList.remove("sh-expanded")),window.dispatchEvent(new CustomEvent("sh-panel-closed"))):H.classList.add("sh-open"))}else{window.__scriptHubLoaded=!0;async function H(S){let T=await crypto.subtle.digest("SHA-256",new TextEncoder().encode(S));return Array.from(new Uint8Array(T)).map(M=>M.toString(16).padStart(2,"0")).join("")}async function R(){return new Promise(S=>{let T=async()=>{let M=document.querySelector("p.user__username");M&&M.textContent?S(await H(M.textContent.trim())):setTimeout(T,500)};T()})}let D=["24deb6961c3cef1d2e3795aaf4b7e3fe8d83d20adff06215426c05827c8351ca","710a0c6095723bc0a46d78897497b5af0417cee56708fdc10cca6860b686ea6e","bc95a4675c77e3ee07d42d825c05e403c3861d29b24ddd57c6e30ebb7a8c2336","49480808159cde937909eaad603911749197829c0cea7a8b68c29e63c98538c0","61678f96fc810a611097d9b0bc98bc8ecb0abee7cd55f2faa19b455604dc2332","2f5ae5e87d1a659e1a01e2bc2c38441bba81bb12eb39d59695b4960576012c55","004381f7f5b3ace58d7dc03a047674325acd266ddc576c273942fdb7237f7130","f355a6794c9a044989a7d2e5bc1e3aa5bff909a38adfbdc68cc0433042ea84b9"];(async()=>{let S=window.__SH_BRANCH||"main",T=!1;if(S==="local")T=!0;else{let t=await R();if(T=t?D.includes(t):!1,S==="development"&&!T)return}let M=S==="local"?"http://localhost:3000/dist":`https://raw.githubusercontent.com/alisohub/fc_amazon/refs/heads/${S}/dist`,k={CRET:{targetRate:47,offTaskMins:4,doubleCountMode:!1,scanTimeoutMs:6e3},FAST:{targetRate:100,offTaskMins:10,doubleCountMode:!1,scanTimeoutMs:4e3},UG:{targetRate:47,offTaskMins:4,doubleCountMode:!0,scanTimeoutMs:6e3},REFURB:{targetRate:30,offTaskMins:10,doubleCountMode:!1,scanTimeoutMs:6e3},WHD:{targetRate:20,offTaskMins:5,doubleCountMode:!1,scanTimeoutMs:6e3}},_=new URLSearchParams(window.location.search).get("gradingMode"),L=[];_==="CRETURN_PRIMARY_GRADING"?L=["UG"]:_==="CRETURN"?L=["FAST","CRET"]:_==="CRETURN_REFURB"?L=["REFURB"]:_==="WAREHOUSE_DEALS"?L=["WHD"]:L=["FAST","CRET","UG","REFURB","WHD"];function C(t){return t==="FAST"||t==="CRET"||t==="UG"||t==="REFURB"||t==="WHD"}let I=localStorage.getItem("sh_hub_dep"),v=C(I)&&L.includes(I)?I:L[0];if(I!==v)try{localStorage.setItem("sh_hub_dep",v)}catch{}let A=[{id:"item-counter",name:"\u0420\u0430\u0445\u0443\u0432\u0430\u043B\u044C\u043D\u0438\u043A",file:"counter.js",description:"\u0420\u0430\u0445\u0443\u0454 \u043F\u0430\u0447\u043A\u0438, \u043C\u043E\u0436\u0435\u0442\u0435 \u0441\u0445\u043E\u0432\u0430\u0442\u0438 \u0437 \u0435\u043A\u0440\u0430\u043D\u0443 \u0437\u0430 \u0434\u043E\u043F\u043E\u043C\u043E\u0433\u043E\u044E F10. \u0412\u0438\u0441\u0442\u0430\u0432\u0442\u0435 \u043F\u0435\u0440\u0435\u0440\u0432\u0443.",getHandler:()=>window.__itemCounter,renderSettings:t=>{let a=window.__itemCounter;if(!a)return;let o=a.getSettings(),f=a.getCount(),m=k[v]?k[v].targetRate:47,x=k[v]?k[v].doubleCountMode:!1,b=k[v]?k[v].scanTimeoutMs:6e3,p=o.targetRate!==void 0?o.targetRate:m;a.updateSettings({targetRate:p,doubleCountMode:x,scanTimeoutMs:b}),t.innerHTML=`
